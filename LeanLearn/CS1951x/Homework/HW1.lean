...
––––––––––––––––––––––––––––––––––––––– Var     ––––––––––––––––––––– Var   ––––––––––––––––––––––––––––––– Var –––––––––––––––––––––– Var
C, f : (α → β → γ),.. ⊢ f : α → β → γ           C, .., a : α ⊢ a : α        C, .., g : (α → β) ⊢ g : α → β      C, .., a : α  ⊢ a : α
––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––– App   –––––––––––––––––––––––––––––––––––––––––––––––––– App
C, f : (α → β → γ), g : (α → β), a : α ⊢ f a : β → γ                        C, f : (α → β → γ), g : (α → β), a : α ⊢ g α : β
–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––– App
C, f : (α → β → γ), g : (α → β), a : α ⊢ f a (g a) : γ
–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––– Fun
C, f : (α → β → γ), g : (α → β) ⊢ λ a : α => f a (g a) : α → γ
–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––– Fun
C, f : (α → β → γ) ⊢ λ g : (α → β) => λ a : α => f a (g a) : (α → β) → α → γ
–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––– Fun
C ⊢ (λ f : (α → β → γ) => λ g : (α → β) => λ a : α => f a (g a) ) : (α → β → γ) → (α → β) → α → γ
...
theorem flatten_singletons : {α : Type} → ∀ xs : List α, xs = (flatten ∘ singletons) xs  := sorry
...
-- Counter example:
#eval singletons (flatten [[1],[3,4]])


-- TODO: Finish the proof that these are not the same.

theorem flatten_then_singletons_not_id (h : {α : Type} → ∀ xs : List (List α), xs = singletons (flatten xs)) : False :=
    have counter : List (List ℕ):= [[1],[3,4]]
    have what : counter = singletons (flatten counter) := h counter
    have noter := singletons (flatten counter)
    sorry
